...
$JAVA_HOME_1_6/bin/javac  -target 1.6 -encoding UTF-8  -sourcepath  ../src  -classpath  ../referenced_libraries/guava-23.0.jar:../referenced_libraries/commons-beanutils-1.8.0.jar:../referenced_libraries/commons-collections-3.2.1.jar:../referenced_libraries/commons-lang-2.5.jar:../referenced_libraries/commons-logging-1.1.1.jar:../referenced_libraries/ezmorph-1.0.6.jar:../referenced_libraries/json-lib-2.4-jdk15.jar -d temp/ -g:none ../src/${PACKAGE}/*.java  ../src/${PACKAGE}/core/*.java ../src/${PACKAGE}/api/*/*.java ../src/${PACKAGE}/model/*.java ../src/${PACKAGE}/util/*.java
cd temp/
